  ...
  const privacyPolicyData = [
    {
      ...
      content:
        "At Shree Krishna Digital Marketing, we value the privacy of our clients and website visitors. We are committed to safeguarding any personal information shared with us and ensuring it is handled responsibly. As a forward-thinking digital marketing and IT services provider, we prioritize confidentiality and adhere to industry-standard privacy practices. This policy outlines how we collect, use, protect, and share your data when you engage with our services or visit our website.",
    },
    {
      section: "Information We Collect",
      subsections: [
        {
          title: "When We Collect",
          points: [
    ...
    },
    {
      ...
      points: [
        ...
        "Third-Party Service Providers: When required to deliver specific services.",
        "Legal Obligations: If required by law or to comply with legal proceedings.",
        "Business Transfers: In the event of a merger, acquisition, or partnership.",
      ],
    ...
    },
    {
      ...
      content:
        "Our website may contain links to external websites or blogs. We are not responsible for their privacy policies or content. We encourage you to review third-party privacy practices before interacting with external sites.",
    },
    {
      section: "Policy Changes",
      content:
        "We reserve the right to update this Privacy Policy at any time. Changes will be posted on this page with the revised effective date. We encourage you to review this policy periodically to stay informed.",
    },
    {
      section: "Contact Us",
      content: [
