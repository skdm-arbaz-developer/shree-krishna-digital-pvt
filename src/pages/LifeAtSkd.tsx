...
export default function LifeAtSkd() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Life at digital marketing agency in Mumbai | Shree Krishna Digital
        </title>
        <meta
          name="description"
          content="Discover what life is like at a digital marketing agency in Mumbai. Experience creative teamwork, a dynamic culture, and exciting projects driving online success."
        />
        <meta
          name="keywords"
        ...
        <link
          rel="canonical"
          href="https://skdm.in/life-at-digital-marketing-agency-mumbai"
        />
        ...
        <meta
          property="og:title"
          content="Life at digital marketing agency in Mumbai | Shree Krishna Digital"
        />
      ...
      <CommanBanner
        image={banner}
        title="Life at SKD"
        keyword="Life At Digital Marketing Agency In Mumbai"
      ...
      <section className="section">
        <div className="container mx-auto px-0 sm:px-5 xl:px-0">
          <div className="section-body flex flex-col justify-center lg:items-center mb-15">
            ...
            <p
              className="section-contet lg:text-center"
              style={{ maxWidth: 750 }}
            >
              At Shree Krishna Digital Solutions Pvt Ltd, we believe in creating
              lasting memories that reflect our vibrant culture and team spirit.
              From festive celebrations to team outings, every moment is a
              testament to our commitment to fostering a positive and engaging
              work environment.
            </p>
          </div>
          <ConfigProvider
