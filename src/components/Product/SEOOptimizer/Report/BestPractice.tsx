...
export default function BestPractice({ data }: any) {
  return (
    <div className="details">
      <div className="mb-5 flex flex-col items-center col-span-5">
        <GaugeChart
          value={parseFloat(data?.categories["best-practices"]?.score) * 100}
          type="ring"
          size={200}
        />
      ...
      <div className="spanshots mt-10">
        ...
        {data?.categories["best-practices"]?.auditRefs
          ?.filter((val: any) => val?.group === "best-practices-general")
          ?.sort((a: any, b: any) => {
