...
const services = [
  {
    ...
    keyword: "Best SEO Company In Mumbai",
    metaTitle: "Best SEO Company in Mumbai | Shree Krishna Digital",
    metaDes:
      "Partner with the best SEO company in Mumbai to improve your search rankings, increase organic traffic, and grow your business with proven SEO strategies.",
  ...
  },
  {
    ...
    keyword: "Social Media Marketing Agency In Mumbai",
    metaTitle:
      "Social Media Marketing agency in Mumbai | Shree Krishna Digital",
    metaDes:
      "Hire Mumbai’s leading social media marketing agency to boost your brand online with expert content, paid ads, and community management for real results.",
  ...
  },
  {
    ...
    keyword: "Google My Business listing service",
    metaTitle: "Google My Business Listing service | Shree Krishna Digital",
    metaDes:
      "Enhance your local visibility with our Google My Business service. Get accurate info, customer reviews, and improved local search rankings to attract more customers.",
  ...
  },
  {
    banner: PpcBannner,
    title: "Pay Per Click",
    keyword: "PPC Agency Mumbai",
    metaTitle: "PPC Agency Mumbai | Shree Krishna Digital",
    metaDes:
      "Maximize ROI with the leading PPC agency in Mumbai. Experts create high-converting Google Ads and campaigns to drive traffic, leads, and sales.",
  ...
  },
  {
    ...
    metaDes:
      "Looking for a professional web development company in Mumbai? We create responsive, user-friendly, SEO-optimized websites tailored to your needs.",
  ...
  },
  {
    ...
    keyword: "App Development Company In Mumbai",
    metaTitle: "App Development Company in Mumbai | Shree Krishna Digital",
    metaDes:
      "Hire the top app development company in Mumbai for innovative, user-friendly mobile solutions. We specialize in Android, iOS, and cross-platform apps.",
